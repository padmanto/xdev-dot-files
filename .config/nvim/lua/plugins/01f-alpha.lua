return {
	...
	config = function()
		...
		local header = {
			type = "text",
			val = {
				"  _________.__ __________             ________                   .__     ",
				" /   _____/|__|\\______   \\  ____      \\______ \\  _____     ______|  |__  ",
				" \\_____  \\ |  | |     ___/_/ __ \\      |    |  \\ \\__  \\   /  ___/|  |  \\ ",
				" /        \\|  | |    |    \\  ___/      |    `   \\ / __ \\_ \\___ \\ |   Y  \\",
				"/_______  /|__| |____|     \\___  >    /_______  /(____  //____  >|___|  /",
				"        \\/                     \\/             \\/      \\/      \\/      \\/ ",
			},
			opts = {
				position = "center",
		...
		local buttons = {
			...
			val = {
				...
				dashboard.button("SPC f r", "󰊄  Live grep"),
